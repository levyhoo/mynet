...
namespace bson {
    ...
    */
    const int BSONObjMaxInternalSize = BSONObjMaxUserSize + ( 128 * 1024 );
    ...
    public:
        ...
        static TrivialAllocator& defaultInstance() {
            static TrivialAllocator instance;
            return instance;
        }
    };
    ...
    public:
        ...
        static StackAllocator& defaultInstance() {
    ...
    class _BufBuilder {
        ...
        Allocator& al;
    public:
        _BufBuilder(int initsize = 512, Allocator& a = Allocator::defaultInstance()) : al(a), size(initsize) {
            if ( size > 0 ) {
